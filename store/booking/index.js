...
export const actions = {
    fetchPassengers({ commit }, params) {
        return this.$axios.get('/api/passengers', params).then(response => {
            commit('SET_PASSENGERS', response.data)
        })
    },
    fetchBookings({ commit }, params) {
        return this.$axios.get('/api/bookings', params).then(response => {
    ...
    fetchDataTable({ commit, getters }) {
        ...
        return this.$axios.get('/api/bookings', { params: getters.getDataTableParams }).then(response => {
